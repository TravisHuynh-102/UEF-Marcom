...
export const mockContentItems: ContentItem[] = [
  { id: 'c1', title: 'Global Pass — Launch Teaser', type: 'Video', platform: 'TikTok', scheduledDate: '2026-06-02', scheduledTime: '19:00', status: 'Published', assignee: mockUsers[8], approvedBy: mockUsers[0], description: '30s teaser', projectName: 'Global Pass', projectId: 'p1' },
  { id: 'c2', title: 'UEF Campus Life Photos', type: 'SocialPost', platform: 'Facebook', scheduledDate: '2026-06-03', scheduledTime: '10:00', status: 'Published', assignee: mockUsers[9], approvedBy: mockUsers[4], description: 'Photo carousel', projectName: 'Page Cư dân UEF', projectId: 'p3' },
  ...
  { id: 'c4', title: 'Global Pass Benefits Infographic', type: 'SocialPost', platform: 'Instagram', scheduledDate: '2026-06-05', scheduledTime: '11:30', status: 'Approved', assignee: mockUsers[6], approvedBy: mockUsers[2], description: 'Benefits infographic', projectName: 'Global Pass', projectId: 'p1' },
  ...
  { id: 'c8', title: 'Livestream Ep.13 — Tech Trends', type: 'Livestream', platform: 'Facebook', scheduledDate: '2026-06-08', scheduledTime: '20:00', status: 'PendingReview', assignee: mockUsers[7], description: 'Tech trends session', projectName: 'Livestream', projectId: 'p2' },
  { id: 'c9', title: 'UEF Scholarship Announcement', type: 'SocialPost', platform: 'Facebook', scheduledDate: '2026-06-09', scheduledTime: '08:00', status: 'Approved', assignee: mockUsers[9], approvedBy: mockUsers[4], description: 'Scholarship opening', projectName: 'Page Cư dân UEF', projectId: 'p3' },
